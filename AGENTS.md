...
- **Dependencies**: None. No `package.json`, `requirements.txt`, `Cargo.toml`, `go.mod`, `docker-compose.yml`, or similar files are present. The VM update script is a no-op (`true`).
